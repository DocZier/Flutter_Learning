...
import 'package:test_practic/data/datasources/local/progress/progress_local_source.dart';
import 'package:test_practic/data/datasources/remote/progress/progress_remote_source.dart';
...
abstract class ProgressRepository {
  ...
  Future<List<LearningProgressEntity>> getLearningProgressHistory(int userId, {int days = 30});
}
...
class ProgressRepositoryImpl implements ProgressRepository {
  ...
  @override
  Future<List<LearningProgressEntity>> getLearningProgressHistory(
      int userId, {int days = 30}) async {
    final today = DateTime.now();
    final history = <LearningProgressEntity>[];
    ...
    for (int i = days - 1; i >= 0; i--) {
      ...
      history.add(LearningProgressEntity(
        date: date,
